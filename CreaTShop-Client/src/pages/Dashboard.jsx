...
const Dashboard = () => {
  ...
  const chartData = {
    labels: [t('admin.users'), t('admin.products'), t('admin.categories')],
    datasets: [
      {
        label: t('admin.chartLabel'),
    ...
    <div className="container mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-5">
        <div className="bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-lg shadow-lg p-8 text-center">
          <h3 className="text-xl font-bold mb-3">{t('admin.totalUsers')}</h3>
          <p className="text-4xl font-extrabold">{countUser}</p>
          <p className="text-sm mt-2 opacity-75">{t('admin.activeUsers')}</p>
        </div>
        <div className="bg-gradient-to-br from-green-500 to-teal-600 text-white rounded-lg shadow-lg p-8 text-center">
          <h3 className="text-xl font-bold mb-3">{t('admin.totalProducts')}</h3>
          <p className="text-4xl font-extrabold">{countProduct}</p>
          <p className="text-sm mt-2 opacity-75">{t('admin.productsAvailable')}</p>
        </div>
        <div className="bg-gradient-to-br from-purple-500 to-pink-600 text-white rounded-lg shadow-lg p-8 text-center">
          <h3 className="text-xl font-bold mb-3">{t('admin.totalCategories')}</h3>
          <p className="text-4xl font-extrabold">{countCategory}</p>
          <p className="text-sm mt-2 opacity-75">{t('admin.categoriesListed')}</p>
        </div>
      </div>
