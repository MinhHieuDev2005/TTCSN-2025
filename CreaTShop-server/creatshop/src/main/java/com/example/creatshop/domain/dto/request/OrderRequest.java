...
public class OrderRequest {
    ...
    @NotNull(message = ErrorMessage.Validate.ERR_ADDRESS_ID_NOT_NULL)
    @Min(value = 1, message = ErrorMessage.Validate.ERR_ADDRESS_ID_MIN)
    Integer addressId;

    @Valid
    @NotNull(message = ErrorMessage.Validate.ERR_ORDER_ITEMS_NOT_NULL)
    @NotEmpty(message = ErrorMessage.Validate.ERR_ORDER_ITEMS_NOT_NULL)
