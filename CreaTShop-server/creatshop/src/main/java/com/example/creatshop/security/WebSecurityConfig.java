        ...
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            .authorizeHttpRequests(auth ->
                    auth.requestMatchers(HttpMethod.GET, Endpoint.V1.Category.PREFIX + CATCH_ALL_WILDCARD).permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, Endpoint.V1.PREFIX + "/vnpay/ipn").permitAll()
                        .requestMatchers(HttpMethod.GET, Endpoint.V1.PREFIX + "/vnpay/return").permitAll()
                        .requestMatchers(HttpMethod.GET, Endpoint.V1.PREFIX + "/vnpay/create-payment").authenticated()
                        .requestMatchers(Endpoint.V1.Order.MOVE_TO_NEXT_STATUS + CATCH_ALL_WILDCARD).hasRole("ADMIN")
